  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="row mt-2" v-for="(field, key) in fields" :key="key">
        <div class="col-md-2">
          <input type="text"  v-model="field.icon" name="icon" id="icon" class="form-control" placeholder="Icono">
        </div>
        <div class="col-md-3">
          <input type="text"  v-model="field.title" name="title" id="icon" class="form-control" placeholder="Titulo">
        </div>
        <div class="col-md-6">
          <input type="text"  v-model="field.url" name="url" id="icon" class="form-control" placeholder="Link">
        </div>
        <div class="col">
